                      ...
                      <div className="col-md-7">
                        <ul className="personal-info">
                          ...
                          <li>
                            ...
                            <div className="text">{patient.age}</div>
                          </li>
                          <li>
                            <div className="title">Address:</div>
                            <div className="text">{patient.address}</div>
                          </li>
                          <li>
          ...
          >
            ...
            <div className="row">
              <div className="col-md-6 d-flex">
                <div className="card profile-box flex-fill">
                  <div className="card-body">
                    <h3 className="card-title">Insurance information</h3>
                    <ul className="personal-info">
                      <li>
                      ...
                      <li>
                        <div className="title">Policy No.</div>
                        <div className="text">159843014641</div>
                      </li>
                      <li>
                        <div className="title">Limit</div>
                        <div className="text">Rs. 500000</div>
                      </li>
                    </ul>
                  </div>
                </div>
